// sales-dashboard.component.ts - FIXED ROUTER INJECTION
...
export class SalesDashboardComponent implements OnInit, AfterViewInit {
  ...
  // Navigate to activities management page
  onActClick(): void {
    // Option 1: Navigate to activities management route
    this.router.navigate(['/sales/activities']);

    // Option 2: If you want to stay on dashboard and just scroll
